...
BLOG_AUTHOR = "每一步都算数"  # (translatable)
BLOG_TITLE = "人生没有白走的路，每一步都算数"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://stepbystepeveryday.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://stepbystepeveryday.github.io/"
BLOG_EMAIL = "stepbystepeveryday@protonmail.com"
BLOG_DESCRIPTION = "人生没有白走的路，每一步都算数"  # (translatable)
